package es.prorix.ficheros.crud.model.file;
...
import es.prorix.ficheros.crud.Interface.Operations;
import es.prorix.ficheros.crud.model.Empleado;

/**
 * Clase con las operaciones para el archivo
 * @author prorix
 * @version 1.0.0
 */
...
public class FileOperations implements Operations {
    ...
    /**
     * Metodo para agregar un empleado al fichero
    ...
    /**
     * Metodo para aniadir informacion al fichero
    ...
    /**
     * Metodo para leer un empleado por su identificador
    ...
    /**
     * Metodo para leer la informacion de un empleado
    ...
    /**
     * Metodo para actualizar la informacion del ficher0
    ...
    /**
     * Metodo para eliminar a un empleado de la empresa
    ...
    /**
     * Metodo para devolver una lista de empleados de un puesto
    ...
    /**
     * Metodo para devolver una lista de empleados por edad
